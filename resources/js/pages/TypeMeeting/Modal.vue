...
<template>
    ...
    <Dialog v-model:open="open">
        <DialogContent>
            ...
            >
                <div class="space-y-2">
                    <Label for="edit-type_meeting_code"
                        >Type Code</Label
                    >
                    <Input
                        id="edit-type_meeting_code"
                        v-model="editForm.type_meeting_code"
                        type="text"
                        class="mt-1 w-full"
                ...
                <div class="space-y-2">
                    <Label for="edit-type_meeting_name"
                        >Type Name</Label
                    >
                    <Input
                        id="edit-type_meeting_name"
                        v-model="editForm.type_meeting_name"
                        type="text"
                        class="mt-1 w-full"
                ...
                <div class="space-y-2">
                    <Label for="edit-type_meeting_description"
                        >Type Description</Label
                    >
                    <Input
                        id="edit-type_meeting_description"
                        v-model="editForm.type_meeting_description"
                        type="text"
                    ...
                    />
                    <InputError
                        :message="editForm.errors?.type_meeting_description"
                    />
                </div>
