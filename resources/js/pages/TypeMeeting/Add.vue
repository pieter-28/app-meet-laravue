...
<template>
    ...
    <Dialog v-model:open="open">
        <DialogContent>
            <DialogHeader>
                <DialogTitle>Add Type Meeting</DialogTitle>
                <DialogDescription> Add a new type meeting. </DialogDescription>
            </DialogHeader>
            <form @submit.prevent="$emit('confirm')" class="space-y-4">
                ...
                <div class="space-y-2">
                    ...
                    />
                    <InputError :message="addForm.errors?.type_meeting_name" />
                </div>
                <div class="space-y-2">
                    ...
                    <Input
                        ...
                        v-model="addForm.type_meeting_description"
                        type="text"
                    ...
                    />
                    <InputError
                        :message="addForm.errors?.type_meeting_description"
                    />
                </div>
