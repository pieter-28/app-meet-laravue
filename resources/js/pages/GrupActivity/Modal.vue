        ...
        <DialogContent>
            <DialogHeader>
                ...
                <DialogDescription>
                    {{
                        mode === 'create'
                            ? 'Add a new grup activity.'
                            : 'Update grup activity.'
                    }}
                </DialogDescription>
            </DialogHeader>
            <form @submit.prevent="$emit('confirm')" class="space-y-4">
                <div class="space-y-2">
                    <Label for="add-grup_activity_name"
                        >Grup Activity Name</Label
                    >
                    <Input
                        id="add-grup_activity_name"
                        v-model="form.name"
                        type="text"
                        class="mt-1 w-full"
                        placeholder="Grup activity name"
                    />
